...
const Register = () => {
  ...
  const handleSignup = async (e) => {
    ...
    if (error) {
      ...
      setSuccessMsg('Provisioning complete. Redirecting...');
    ...
    <AuthModal>
       <div className="p-8 md:p-12 bg-surface">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-text mb-2">Create Identity</h1>
          <p className="text-sm text-text-secondary font-normal">Join the UV Netware ecosystem today.</p>
        </div>
        ...
        {successMsg && (
          <div className="mb-6 p-4 bg-emerald-50 border border-emerald-100 text-emerald-600 text-sm rounded-xl text-center font-medium">
            {successMsg}
          </div>
        )}
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              >
                <option value="Owner">Owner (Business Control)</option>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="btn-primary w-full py-4 text-base shadow-sm mt-4"
          >
        ...
        <div className="my-10 flex items-center justify-between">
          ...
          <span className="px-4 text-[10px] text-text-secondary font-bold tracking-widest uppercase bg-surface">OR</span>
          <span className="border-b border-border w-full"></span>
        </div>

        <div className="grid grid-cols-1 gap-4 mb-8">
          <button onClick={() => handleOAuth('google')} type="button" className="btn-ghost w-full py-3 text-sm font-semibold flex items-center justify-center gap-3">
        ...
        <div className="text-center text-sm font-normal">
          <span className="text-text-secondary">Already established? </span>
