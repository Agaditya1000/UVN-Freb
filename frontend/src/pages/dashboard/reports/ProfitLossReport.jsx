...
const LineBlock = ({ title, lines, tone, symbol }) => (
  <div className="mb-6">
...
const ProfitLossReport = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {!loading && pl && (
        <>
          <LineBlock title="Revenue" lines={pl.revenueLines} tone="text-emerald-600" symbol={symbol} />
          <LineBlock title="Expenses" lines={pl.expenseLines} tone="text-red-600" symbol={symbol} />
