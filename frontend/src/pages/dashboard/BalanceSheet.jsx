...
const BalanceSheet = () => {
  ...
  const handleExportExcel = () => {
    ...
    const header = [
      ['Statement Generated By: UV Netware Utilities'],
      [''],
  ...
  const handleExportPDF = () => {
    ...
    doc.text('Generated via UV Netware Utilities', 105, 15, { align: 'center' });

    doc.setFontSize(22);
    doc.setTextColor(0, 0, 33);
    doc.text(activeBusiness.name.toUpperCase(), 105, 30, { align: 'center' });
    doc.setFontSize(14);
    doc.setTextColor(100);
    doc.text('STATEMENT OF FINANCIAL POSITION', 105, 40, { align: 'center' });
    doc.setFontSize(9);
    doc.text(`Tax ID: ${activeBusiness.tax_id || 'N/A'} | Page Generated: ${currentTime.toLocaleString()}`, 105, 48, { align: 'center' });
    autoTable(doc, {
      startY: 55,
      ...
      <div className="bg-surface border border-border rounded-[40px] shadow-2xl overflow-hidden relative group">
        ...
        <div className="p-10 md:p-16 text-center border-b border-border/50 relative overflow-hidden">
           <div className="flex items-center justify-center gap-4 mb-10 group cursor-default">
             <div className="flex items-center justify-center w-14 h-14 bg-primary/10 text-primary rounded-2xl font-black text-2xl shadow-sm ring-1 ring-primary/20 italic tracking-tighter group-hover:bg-primary group-hover:text-white transition-all duration-300">
               UV
             </div>
             <div className="flex flex-col items-start justify-center text-left">
               <span className="text-2xl font-black text-text tracking-tight uppercase leading-none mb-1">UV Netware</span>
               <span className="text-[11px] font-bold text-primary uppercase tracking-[0.3em] leading-none">Utilities</span>
             </div>
           </div>
           ...
           <h3 className="text-xl font-bold text-text-secondary uppercase tracking-[0.3em] mb-4">Statement of Financial Position</h3>
